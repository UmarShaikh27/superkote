  ...
  return (
    <div className='py-24'>
        <div className="text-gray-600 body-font">
            <div className=" px-6 sm:px-12 grid grid-flow-row grid-cols-1 md:grid-cols-2 items-center bg-gray-200">
        ...
        <div className="text-gray-600 body-font">
            <div className=" my-24 px-6 sm:px-12 flex md:flex-row flex-col-reverse items-center bg-gray-200">              
